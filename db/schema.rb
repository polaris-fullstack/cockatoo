...
ActiveRecord::Schema[8.0].define(version: 2025_04_17_124313) do
  ...
  create_table "applicants", force: :cascade do |t|
    t.bigint "finance_application_id", null: false
    t.string "title"
    t.string "surname"
    ...
    t.decimal "income"
    t.decimal "expenses"
    t.index ["finance_application_id"], name: "index_applicants_on_finance_application_id"
  end

  create_table "applications", force: :cascade do |t|
    t.string "purpose"
    t.boolean "first_time_owner"
    t.boolean "fhog_eligible"
    t.text "assets"
    t.text "liabilities"
    t.integer "income"
    t.integer "expenses"
    ...
    t.float "likelihood_of_approval"
  ...
  create_table "employment_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["applicant_id"], name: "index_employment_histories_on_applicant_id"
  end
  ...
  create_table "properties", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "finance_application_id"
    ...
    t.index ["finance_application_id"], name: "index_properties_on_finance_application_id"
  end
  ...
  add_foreign_key "applicants", "applications", column: "finance_application_id"
  add_foreign_key "documents", "applicants"
  add_foreign_key "employment_histories", "applicants"
  add_foreign_key "pay_charges", "pay_customers", column: "customer_id"
  add_foreign_key "pay_payment_methods", "pay_customers", column: "customer_id"
  add_foreign_key "pay_subscriptions", "pay_customers", column: "customer_id"
  add_foreign_key "properties", "applications", column: "finance_application_id"
end
